...
}]);;app.controller('photoController', ['$scope', '$interval', function($scope, $interval) {
	$scope.mode = 'query';
...
}]);;app.controller('challengeController', ['$scope', '$interval', function($scope, $interval) {
	$scope.mode = 'query';
	$scope.determinateValue = 30;
	$interval(function() {
		$scope.determinateValue += 1;
...
}]);;app.controller('settingsController', ['$scope', '$interval', function($scope, $interval) {
	$scope.mode = 'query';
	$scope.determinateValue = 30;
	$interval(function() {
		$scope.determinateValue += 1;
